    ...
    public partial class final : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1", new DateTime(2024, 4, 5, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6570), 10.99m },
                    { 2, "2", new DateTime(2024, 4, 4, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6654), 25.00m },
                    { 3, "3", new DateTime(2024, 4, 3, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6664), 18.50m },
                    { 4, "4", new DateTime(2024, 4, 2, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6678), 32.75m },
                    { 5, "5", new DateTime(2024, 4, 1, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6686), 14.99m },
                    { 6, "6", new DateTime(2024, 3, 31, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6694), 20.25m },
                    { 7, "7", new DateTime(2024, 3, 30, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6702), 27.50m },
                    { 8, "8", new DateTime(2024, 3, 29, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6709), 45.75m },
                    { 9, "9", new DateTime(2024, 3, 28, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6717), 62.99m },
                    { 10, "10", new DateTime(2024, 3, 27, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6724), 28.50m },
                    { 11, "11", new DateTime(2024, 3, 26, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6733), 35.99m },
                    { 12, "12", new DateTime(2024, 3, 25, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6746), 52.25m },
                    { 13, "13", new DateTime(2024, 3, 24, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6753), 75.99m },
                    { 14, "14", new DateTime(2024, 3, 23, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6764), 42.75m },
                    { 15, "15", new DateTime(2024, 3, 22, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6774), 55.50m },
                    { 16, "12", new DateTime(2024, 3, 21, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6782), 38.25m },
                    { 17, "10", new DateTime(2024, 3, 20, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6790), 49.99m },
                    { 18, "8", new DateTime(2024, 3, 19, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6797), 65.75m },
                    { 19, "6", new DateTime(2024, 3, 18, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6805), 80.50m },
                    { 20, "10", new DateTime(2024, 3, 17, 15, 40, 54, 480, DateTimeKind.Local).AddTicks(6817), 95.25m }
                });
