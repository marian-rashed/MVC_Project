    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 30, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(940), 10.99m },
                    { 2, 2, new DateTime(2024, 3, 29, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(987), 25.00m },
                    { 3, 3, new DateTime(2024, 3, 28, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(992), 18.50m },
                    { 4, 4, new DateTime(2024, 3, 27, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(995), 32.75m },
                    { 5, 5, new DateTime(2024, 3, 26, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(998), 14.99m },
                    { 6, 6, new DateTime(2024, 3, 25, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1001), 20.25m },
                    { 7, 7, new DateTime(2024, 3, 24, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1004), 27.50m },
                    { 8, 8, new DateTime(2024, 3, 23, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1007), 45.75m },
                    { 9, 9, new DateTime(2024, 3, 22, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1010), 62.99m },
                    { 10, 10, new DateTime(2024, 3, 21, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1013), 28.50m },
                    { 11, 11, new DateTime(2024, 3, 20, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1016), 35.99m },
                    { 12, 12, new DateTime(2024, 3, 19, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1019), 52.25m },
                    { 13, 13, new DateTime(2024, 3, 18, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1022), 75.99m },
                    { 14, 14, new DateTime(2024, 3, 17, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1025), 42.75m },
                    { 15, 15, new DateTime(2024, 3, 16, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1027), 55.50m },
                    { 16, 12, new DateTime(2024, 3, 15, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1030), 38.25m },
                    { 17, 10, new DateTime(2024, 3, 14, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1033), 49.99m },
                    { 18, 8, new DateTime(2024, 3, 13, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1036), 65.75m },
                    { 19, 6, new DateTime(2024, 3, 12, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1039), 80.50m },
                    { 20, 10, new DateTime(2024, 3, 11, 17, 33, 20, 675, DateTimeKind.Local).AddTicks(1041), 95.25m }
                });
