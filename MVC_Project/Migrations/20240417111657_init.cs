    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1", new DateTime(2024, 4, 17, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6555), 10.99m },
                    { 2, "2", new DateTime(2024, 4, 16, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6609), 25.00m },
                    { 3, "3", new DateTime(2024, 4, 15, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6617), 18.50m },
                    { 4, "4", new DateTime(2024, 4, 14, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6623), 32.75m },
                    { 5, "5", new DateTime(2024, 4, 13, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6686), 14.99m },
                    { 6, "6", new DateTime(2024, 4, 12, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6694), 20.25m },
                    { 7, "7", new DateTime(2024, 4, 11, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6704), 27.50m },
                    { 8, "8", new DateTime(2024, 4, 10, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6711), 45.75m },
                    { 9, "9", new DateTime(2024, 4, 9, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6717), 62.99m },
                    { 10, "10", new DateTime(2024, 4, 8, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6724), 28.50m },
                    { 11, "11", new DateTime(2024, 4, 7, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6730), 35.99m },
                    { 12, "12", new DateTime(2024, 4, 6, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6736), 52.25m },
                    { 13, "13", new DateTime(2024, 4, 5, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6743), 75.99m },
                    { 14, "14", new DateTime(2024, 4, 4, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6749), 42.75m },
                    { 15, "15", new DateTime(2024, 4, 3, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6759), 55.50m },
                    { 16, "12", new DateTime(2024, 4, 2, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6765), 38.25m },
                    { 17, "10", new DateTime(2024, 4, 1, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6771), 49.99m },
                    { 18, "8", new DateTime(2024, 3, 31, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6778), 65.75m },
                    { 19, "6", new DateTime(2024, 3, 30, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6784), 80.50m },
                    { 20, "10", new DateTime(2024, 3, 29, 13, 16, 53, 937, DateTimeKind.Local).AddTicks(6791), 95.25m }
                });
