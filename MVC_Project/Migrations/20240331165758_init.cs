    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 31, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(1977), 10.99m },
                    { 2, 2, new DateTime(2024, 3, 30, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2024), 25.00m },
                    { 3, 3, new DateTime(2024, 3, 29, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2029), 18.50m },
                    { 4, 4, new DateTime(2024, 3, 28, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2032), 32.75m },
                    { 5, 5, new DateTime(2024, 3, 27, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2036), 14.99m },
                    { 6, 6, new DateTime(2024, 3, 26, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2039), 20.25m },
                    { 7, 7, new DateTime(2024, 3, 25, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2042), 27.50m },
                    { 8, 8, new DateTime(2024, 3, 24, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2045), 45.75m },
                    { 9, 9, new DateTime(2024, 3, 23, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2048), 62.99m },
                    { 10, 10, new DateTime(2024, 3, 22, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2051), 28.50m },
                    { 11, 11, new DateTime(2024, 3, 21, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2053), 35.99m },
                    { 12, 12, new DateTime(2024, 3, 20, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2056), 52.25m },
                    { 13, 13, new DateTime(2024, 3, 19, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2059), 75.99m },
                    { 14, 14, new DateTime(2024, 3, 18, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2062), 42.75m },
                    { 15, 15, new DateTime(2024, 3, 17, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2064), 55.50m },
                    { 16, 12, new DateTime(2024, 3, 16, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2067), 38.25m },
                    { 17, 10, new DateTime(2024, 3, 15, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2070), 49.99m },
                    { 18, 8, new DateTime(2024, 3, 14, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2074), 65.75m },
                    { 19, 6, new DateTime(2024, 3, 13, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2077), 80.50m },
                    { 20, 10, new DateTime(2024, 3, 12, 18, 57, 56, 84, DateTimeKind.Local).AddTicks(2080), 95.25m }
                });
