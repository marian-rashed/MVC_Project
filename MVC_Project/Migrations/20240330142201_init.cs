    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 30, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8403), 10.99m },
                    { 2, 2, new DateTime(2024, 3, 29, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8446), 25.00m },
                    { 3, 3, new DateTime(2024, 3, 28, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8453), 18.50m },
                    { 4, 4, new DateTime(2024, 3, 27, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8455), 32.75m },
                    { 5, 5, new DateTime(2024, 3, 26, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8458), 14.99m },
                    { 6, 6, new DateTime(2024, 3, 25, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8460), 20.25m },
                    { 7, 7, new DateTime(2024, 3, 24, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8462), 27.50m },
                    { 8, 8, new DateTime(2024, 3, 23, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8464), 45.75m },
                    { 9, 9, new DateTime(2024, 3, 22, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8467), 62.99m },
                    { 10, 10, new DateTime(2024, 3, 21, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8469), 28.50m },
                    { 11, 11, new DateTime(2024, 3, 20, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8471), 35.99m },
                    { 12, 12, new DateTime(2024, 3, 19, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8473), 52.25m },
                    { 13, 13, new DateTime(2024, 3, 18, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8476), 75.99m },
                    { 14, 14, new DateTime(2024, 3, 17, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8478), 42.75m },
                    { 15, 15, new DateTime(2024, 3, 16, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8501), 55.50m },
                    { 16, 12, new DateTime(2024, 3, 15, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8504), 38.25m },
                    { 17, 10, new DateTime(2024, 3, 14, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8506), 49.99m },
                    { 18, 8, new DateTime(2024, 3, 13, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8508), 65.75m },
                    { 19, 6, new DateTime(2024, 3, 12, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8510), 80.50m },
                    { 20, 10, new DateTime(2024, 3, 11, 16, 22, 0, 967, DateTimeKind.Local).AddTicks(8513), 95.25m }
                });
