    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1", new DateTime(2024, 4, 5, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8396), 10.99m },
                    { 2, "2", new DateTime(2024, 4, 4, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8449), 25.00m },
                    { 3, "3", new DateTime(2024, 4, 3, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8459), 18.50m },
                    { 4, "4", new DateTime(2024, 4, 2, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8467), 32.75m },
                    { 5, "5", new DateTime(2024, 4, 1, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8473), 14.99m },
                    { 6, "6", new DateTime(2024, 3, 31, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8484), 20.25m },
                    { 7, "7", new DateTime(2024, 3, 30, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8491), 27.50m },
                    { 8, "8", new DateTime(2024, 3, 29, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8497), 45.75m },
                    { 9, "9", new DateTime(2024, 3, 28, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8503), 62.99m },
                    { 10, "10", new DateTime(2024, 3, 27, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8509), 28.50m },
                    { 11, "11", new DateTime(2024, 3, 26, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8516), 35.99m },
                    { 12, "12", new DateTime(2024, 3, 25, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8523), 52.25m },
                    { 13, "13", new DateTime(2024, 3, 24, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8530), 75.99m },
                    { 14, "14", new DateTime(2024, 3, 23, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8539), 42.75m },
                    { 15, "15", new DateTime(2024, 3, 22, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8545), 55.50m },
                    { 16, "12", new DateTime(2024, 3, 21, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8551), 38.25m },
                    { 17, "10", new DateTime(2024, 3, 20, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8557), 49.99m },
                    { 18, "8", new DateTime(2024, 3, 19, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8564), 65.75m },
                    { 19, "6", new DateTime(2024, 3, 18, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8570), 80.50m },
                    { 20, "10", new DateTime(2024, 3, 17, 15, 39, 46, 354, DateTimeKind.Local).AddTicks(8577), 95.25m }
                });
