...
namespace MVC_Project
{
    public class Book
    {
        ...
        [RegularExpression(@"^[A-Za-z _-]{2,100}$", ErrorMessage = "Book title must be between 2 and 100 letters and contain only alphabetic characters.")]
        ...
        [RegularExpression("^\\d{1,10}(\\.\\d{1,2})?$", ErrorMessage = "Price must consist of digits and be between 1 and 10 digits long.")]
